				...
				<table class="table table-striped table-bordered">
					...
					<tr>
						...
						<td class="action-td2">
							...
							<a title="terbitkan artikel" href="<?php echo site_url('ucp/artikel/ajukan/'.$ar->artikel_id.'/draft'); ?>" class="btn btn-small btn-success"><i class="icon-check"></i></a>
							<a title="edit" href="<?php echo site_url('ucp/artikel/edit/'.$ar->artikel_id.'/draft'); ?>" class="btn btn-small"><i class="icon-edit"></i></a>
							<a title="delete" href="<?php echo site_url('ucp/artikel/delete/'.$ar->artikel_id.'/draft'); ?>" class="btn btn-small btn-warning"><i class="icon-remove"></i></a>
						</td>
					</tr>
					<?php endforeach; ?>
					<?php endif; ?>
