				...
				<table class="table table-striped table-bordered">
					...
					<tr>
						...
						<td class="action-td2">
							...
							<a title="publish" href="<?php echo site_url('adminpanel/artikel/publish/'.$ar->artikel_id.'/tolak'); ?>" class="btn btn-small btn-success"><i class="icon-ok"></i></a>
							<a title="edit" href="<?php echo site_url('adminpanel/artikel/edit/'.$ar->artikel_id.'/tolak'); ?>" class="btn btn-small"><i class="icon-edit"></i></a>
							<a title="delete" href="<?php echo site_url('adminpanel/artikel/delete/'.$ar->artikel_id.'/tolak'); ?>" class="btn btn-small btn-warning"><i class="icon-remove"></i></a>
						</td>
					</tr>
					<?php endforeach; ?>
					<?php endif; ?>
