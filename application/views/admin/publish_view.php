	...
	<div class="span9">
		<div class="widget">
			<div class="widget-header">
				...
				<h3>Publish Artikel</h3>
			</div> <!-- /widget-header -->

			<div class="widget-content">
				<?php echo form_open('adminpanel/artikel/dopublish/','class="form-horizontal"'); ?>
				<fieldset>
					...
					<div class="control-group">											
						...
						<div class="controls">
							...
							<img border="0" src="<?php echo base_url()."uploads/thumb/".substr($artikel->image,0,-4)."_thumb".substr($artikel->image,-4); ?>" />
							<?php endif; ?>
						</div> <!-- /controls -->
					</div>
					<div class="control-group">											
					...
					<div class="form-actions">	
						<input type="submit" name="publish" value="Publish Artikel" class="btn btn-primary">
					</div>
				</fieldset>
