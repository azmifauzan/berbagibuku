	...
	<ul class="nav pull-right">	  
	  <li class="dropdown">
	    ...
	    <ul class="dropdown-menu">
		    <li>
			<a href="<?php echo site_url('adminpanel/profil'); ?>"><i class="icon-user"></i> Profil  </a>
		    </li>
		    
		    <li class="divider"></li>
		    
		    <li>
			    <a href="<?php echo site_url('adminpanel/login/out'); ?>"><i class="icon-off"></i> Logout</a>
		    </li>
	    </ul>
	  </li>
	</ul>
  ...
  <div class="container">
	...
	<ul id="main-nav" class="nav nav-tabs nav-stacked">
	  ...
	  <li <?php if($menu == 'Home') echo 'class="active"'; ?>>
		  <a href="<?php echo site_url('adminpanel/home'); ?>">
			  <i class="icon-home"></i>
			  Dashboard 		
		  </a>
	  </li>
	  ...
	  <li <?php if($menu == 'Kategori') echo 'class="active"'; ?>>
		  <a href="<?php echo site_url('adminpanel/kategori'); ?>">
			  <i class="icon-th"></i>
			  Kategori	
		  </a>
	  </li>
	  ...
	  <li <?php if($menu == 'User') echo 'class="active"'; ?>>
		  <a href="<?php echo site_url('adminpanel/user'); ?>">
			  <i class="icon-user"></i>
			  User
		  </a>
	  </li>
	  ...
	  <li>
		  <a href="<?php echo site_url('adminpanel/login/out'); ?>">
			  <i class="icon-off"></i>
			  Logout	
		  </a>
	  </li>
