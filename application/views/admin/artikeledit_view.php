	...
	<div class="span9">
		<div class="widget">
			...
			<div class="widget-content">
				<?php echo form_open_multipart('adminpanel/artikel/prosesedit/'.$red,'class="form-horizontal"'); ?>
				<fieldset>
					
					<div class="control-group">											
						<label class="control-label" for="judul">Judul</label>
						<div class="controls">
							<input type="text" class="input-medium span5" id="judul" name="judul" value="<?php echo $artikel->judul; ?>" placeholder="Judul Artikel">
					...
					<div class="control-group">											
						...
						<div class="controls">
							...
							<option <?php if($artikel->kategori_id == $kat->kategori_id) echo 'selected'; ?> value="<?php echo $kat->kategori_id; ?>" title="<?php echo htmlentities($kat->keterangan); ?>" <?php echo set_select('kategori', $kat->kategori_id); ?>><?php echo $kat->nama; ?></option>
					...
					<div class="control-group">											
						...
						<div class="controls">
							<?php if(trim($artikel->image) != "") :?>
							<img border="0" src="<?php echo base_url()."uploads/thumb/".substr($artikel->image,0,-4)."_thumb".substr($artikel->image,-4); ?>" /><br/><br/>
							<?php endif; ?>
					...
					<div class="control-group">											
						...
						<div class="controls">
							<textarea name="artikel" rows="10" cols="50"><?php echo $artikel->isi; ?></textarea>
							<?php echo form_error('artikel','<p class="help-block" style="color:red;">','</p>'); ?>
						</div> <!-- /controls -->
					</div>
					<div class="form-actions">
						<input type="submit" id="publish" name="simpan" value="Simpan" class="btn btn-primary">
					</div>
				</fieldset>
				<?php echo form_hidden('id',$artikel->artikel_id); ?>
				<?php echo form_hidden('creator',$artikel->creator); ?>
				<?php echo form_close(); ?>
